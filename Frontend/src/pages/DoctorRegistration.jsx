    ...
    <div className="max-w-lg mx-auto my-12 p-8 bg-white border border-gray-200 rounded-xl shadow-sm">
      ...
      {step === 1 ? (
        <div className="animate-fadeIn">
          ...
          <input name="age" placeholder="Age" className={inputClass} onChange={handleChange} value={formData.age} required/>
          <input name="email" type="email" placeholder="Email" className={inputClass} onChange={handleChange} value={formData.email} required/>
          <input name="phone" placeholder="Phone" className={inputClass} onChange={handleChange} value={formData.phone} required/>
          ...
          <button onClick={() => setStep(2)} className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 font-semibold transition-colors">
        ...
        <div className="animate-fadeIn">
          ...
          <input name="years_of_experience" placeholder="Years of Experience" className={inputClass} onChange={handleChange} value={formData.years_of_experience} />
          <input name="consultation_fee" placeholder="Consultation Fee (₹)" className={inputClass} onChange={handleChange} value={formData.consultation_fee} />
